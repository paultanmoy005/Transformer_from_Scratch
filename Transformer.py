...
import PositionalEncoding as pse
import EncoderLayer as enc
import DecoderLayer as dec
...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model, num_heads, num_layers, d_ff, max_seq_length, dropout):
        ...
        self.positional_encoding = pse.PositionalEncoding(d_model, max_seq_length)
